...
from .views import ClientListCreateView, ClientDetailView, ContactListCreateView, ContactDetailView, ClientServiceViewSet, AddRemoveClientComplementView
...
urlpatterns = [
    ...
    path('clients/complements/', AddRemoveClientComplementView.as_view(), name='client-complement'),
]
